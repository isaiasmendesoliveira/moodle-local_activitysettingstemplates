...
El plugin busca reducir trabajo repetitivo, inconsistencias y carga cognitiva durante la configuración de actividades. El docente puede reutilizar decisiones de configuración sin duplicar contenido ni sustituir el flujo nativo de Moodle.
...
- Aplicar la plantilla desde el formulario nativo de configuración de Moodle.
- Mostrar solo plantillas compatibles con el tipo de actividad actual.
- Vista previa de las configuraciones antes de aplicarlas.
- Análisis de compatibilidad con estados **Aplicable**, **Atención** y **No aplicable**.
...
- Segundo intento automático para controles dependientes después de que reaccionen las reglas del formulario de Moodle.
- Edición de nombre, descripción, configuraciones incluidas y valores almacenados.
- Gestión de plantillas personales con identificación del tipo de actividad.
- Interfaz responsiva basada en Bootstrap e integrada con Moodle.
- Mensaje contextual inmediato después de aplicar una plantilla.
- Interfaz en inglés, portugués de Brasil y español.
- Sin servicios externos ni dependencias externas de ejecución.

## Flujo de uso

1. Configure y guarde una actividad normalmente.
...
4. Indique un nombre y, opcionalmente, una descripción.
...
11. Revise el formulario nativo de Moodle y guarde la actividad normalmente.
...
Las plantillas son personales y pertenecen a la cuenta que las creó. El plugin almacena en la base de datos de Moodle el propietario, nombre, descripción, tipo de actividad, configuraciones seleccionadas, valores y marcas de tiempo.
...
- Rango declarado para esta versión: Moodle 4.5–5.2.
- Permiso para gestionar actividades en el curso.
- JavaScript habilitado para la vista previa y aplicación.
